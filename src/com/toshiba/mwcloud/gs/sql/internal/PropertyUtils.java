...
class PropertyUtils {
	...
	public static Long getTimeoutProperty(
			Properties props, String name, Long defaultValue)
			throws GSException {
		final String millisecName = name + "Millis";
		final Integer secValue = getIntProperty(props, name);
		final Integer millisecValue = getIntProperty(props, millisecName);
	...
	public static Integer getIntProperty(
			Properties props, String name) throws GSException {
	...
	public static Boolean getBooleanProperty(
			...
			Boolean defaultValue) throws GSException {
		final String strValue = props.getProperty(name);
		if (strValue == null) {
			return defaultValue;
		}
